...
urlpatterns = [
    ...
    path('cohome/preference/',copref,name='copref'),
    ...
    path('faculty/seePendingRequests/<str:id>', seePendingReq, name='seePendingRequests'),
    path('faculty/seeApprovedRequests/<str:id>', seeApprovedReq, name='seeApprovedRequests'),
